...
export const StatusDefault3 = ({ className }) => {
  return (
    <svg
      className={`status-default-3 ${className}`}
      fill="none"
      height="54"
      viewBox="0 0 54 54"
      width="54"
    ...
    >
      <g className="g" filter="url(#filter0_d_12_977)">
        <path
          className="path"
      ...
      <defs className="defs">
        ...
        >
          ...
          <feBlend
            ...
            mode="normal"
            result="effect1_dropShadow_12_977"
          />

          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_dropShadow_12_977"
            mode="normal"
            result="shape"
          />
        </filter>
